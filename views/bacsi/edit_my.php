...
<div class="page">
    ...
    <div class="page-head" style="justify-content:flex-start; align-items:flex-start; gap:12px;">
        <div>
            <div class="page-title">
                Chỉnh sửa hồ sơ bác sĩ: <?= e($bs['full_name'] ?? '') ?>
            </div>
            <div class="page-sub">
                Cập nhật thông tin cá nhân, chuyên khoa, giá khám và mô tả
            </div>
        </div>

        <div class="actions" style="margin-left:0;">
            <a class="btn btn-outline" href="<?= e(base_url('index.php?c=bacsi&a=profile')) ?>">
                ⬅ Quay lại hồ sơ
            </a>
        </div>
    </div>
    ...
    <div class="panel">
        ...
        <!-- ❗ doctor sửa hồ sơ của CHÍNH MÌNH -->
        <form method="post" action="<?= e(base_url('index.php?c=bacsi&a=update_my')) ?>">
